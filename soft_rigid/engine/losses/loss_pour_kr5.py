...
class PourLossKR5:
    def __init__(self, cfg, mpm_sim):
        ...
        self.rigid_control = mpm_sim.primitives[7]
    ...
    def compute_pose_loss_kernel(self, f: ti.i32):
        ...
        self.pose_loss[None] += 10. * (self.rigid_control.position[f][0] - 0.7) ** 2
        self.pose_loss[None] += 10. * (self.rigid_control.position[f][1] - 0.31488457) ** 2
        self.pose_loss[None] += 10. * (self.rigid_control.position[f][2] - 0.5) ** 2

        self.pose_loss[None] += 1.0 * ti.min(0., ti.abs(self.rigid_control.rotation[f][0]) - 1.0) ** 2  # be careful, rotation direction and angle
